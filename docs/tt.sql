...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 10 Novembre 2017 à 15:21
...
(9, 'La', 'Oli', 'oli.lahaye@gmail.com', '012345678', '7ce0359f12857f2a90c7de465f40a95f01cb5da9', 'sdgjsefnfkniu', 1, '2017-06-20 17:27:51', 'Autre', '0000-00-00 00:00:00'),
...
(12, 'Lahaye', 'Olivier', 'olivier.lahaye@gmail.com', '0498076742', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', 'fdc0bea64465ded62ff829f70b93bbaf', 5, '2017-06-20 17:29:22', 'Masculin', '2017-06-06 00:00:00'),
...
--
ALTER TABLE `equipe`
  MODIFY `id_equipe` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT pour la table `interclub`
--
ALTER TABLE `interclub`
  MODIFY `id_interclub` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `match`
  MODIFY `id_match` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=295;
--
-- AUTO_INCREMENT pour la table `personnes`
--
ALTER TABLE `personnes`
  MODIFY `id_personne` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `rencontre`
  MODIFY `id_rencontre` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
--
...
--
ALTER TABLE `match`
  ADD CONSTRAINT `match_ibfk_1` FOREIGN KEY (`FK_rencontre`) REFERENCES `rencontre` (`id_rencontre`) ON DELETE CASCADE;
...
ALTER TABLE `rencontre`
  ...
  ADD CONSTRAINT `rencontre_ibfk_2` FOREIGN KEY (`FK_interclub`) REFERENCES `interclub` (`id_interclub`) ON DELETE CASCADE,
